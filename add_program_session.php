  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-3 text-black">Add Program</h2>
          </div>
          <div class="col-md-7">
            ...
            <form action="add_program.php" method="post">
              ...
              <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                  <div class="col-lg-12">
                    <input type="submit" class="btn btn-primary btn-lg btn-block" value="Add Program">
                  </div>
                </div>
              </div>
            </form>
        ...
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-3 text-black">Add Session</h2>
          </div>
          <div class="col-md-7">
              ...
              <div class="p-3 p-lg-5 border">
                <div class="form-group row">
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="id" name="session" placeholder="Session" required>
                  </div>
                ...
                <div class="form-group row">
                  <div class="col-lg-12">
                    <input type="submit" class="btn btn-primary btn-lg btn-block" value="Add Session">
                  </div>
                </div>
              </div>
            </form>
