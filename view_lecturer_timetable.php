  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-3 text-black">View Lecturer Timetable</h2>
          </div>
          <div class="col-md-7">

            <form action="view_lecturer_timetable_filtered.php" method="post">
              ...
              <div class="p-3 p-lg-5 border">
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <label for="c_email" class="text-black">Lecturer <span class="text-danger">*</span></label>
                      <br />
                          <select name="lecId" required>
                            ...
                            ?>
                                ...
                                <option value="<?php echo $rows ['lecId'] ?>"><?php echo $rows ['lecId']; ?> - <?php echo $rows ['name']; ?></option>
                ...
                <div class="form-group row">
                  <div class="col-lg-12">
                    <input type="submit" class="btn btn-primary btn-lg btn-block" value="View Lecturer Timetable">
                  </div>
                </div>
              </div>
            </form>
