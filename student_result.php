            ...
            <div class="form-group row">
               ...
               <form action="student_result.php" method="post">
                    ...
                    <div class="col-md-12">
                        ...
                        <label for="c_email" class="d-block text-primary h6 text-uppercase">View Different Session Result: </label>
                        ...
                        <input type="submit" class="btn btn-primary btn-lg btn-block" value="View Results">
