      ...
      <div class="container">
        <div class="row">
          <div class="title-section text-center mb-5 col-12">
            <h2 class="text-uppercase">Edit Payment</h2>
          </div>
        </div>
                    ...
                    <td>
                      ...
                      <td>
                        ...
                        <?php
                           ...
                           $record_to_approve = 'Payment/' . $session . "/" . $rows ['id'];
                           
                        ?>

                        <form action="edit_payment_approve.php" method="post">
                      ...
                      <td>
                        ...
                        <?php
                           ...
                           $record_to_remove = 'Payment/' . $session . "/" . $rows ['id'];
                           
                        ?>

                        <form action="edit_payment_remove.php" method="post">
