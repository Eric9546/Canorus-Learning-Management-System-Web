      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-7">
            ...
            <form action="edit_user_execute.php" method="post">
             ...
             ?>
              ...
              <div class="p-3 p-lg-5 border">
                <div class="form-group row">
                  <div class="col-md-6">
                    <label for="text" class="text-black">User ID To Be Edited:</label>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                    ...
                    ?> 
                        ...
                        <option value="N/A">Staff Member</option>
                ...
                <div class="form-group row">
                  <div class="col-lg-12">
                    <input type="submit" class="btn btn-primary btn-lg btn-block" value="Edit User">
                  </div>
                </div>
              </div>
            </form>
