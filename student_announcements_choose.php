  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-3 text-black">View Announcements</h2>
          </div>
          <div class="col-md-7">

            <form action="student_announcements_filtered.php" method="post">
          ...
          <div class="col-md-5 ml-auto">
            ...
            <div class="p-4 border mb-3">
                ...
                <p><img src="images/function14.jpg" width="400" height="300"/></p>
