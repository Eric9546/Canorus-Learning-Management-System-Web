      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            ...
            <div class="col-lg-4 col-md-6 item-entry mb-4">
                <a href="student_attendance_choose.php" class="product-item md-height bg-gray d-block" style="height:300px; width:300px">
                    <img src="images/function15.jpg" alt="Image" class="img-fluid" height="250" width="250" />
                </a>
                <h5 class="item-price">
                    <a href="student_attendance_choose.php">Attendance</a>
                </h5>
            </div>
