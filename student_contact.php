  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-3 text-black">Contact Lecturer</h2>
          </div>
          <div class="col-md-7">

            <form action="student_contact_execute.php" method="post">
              ...
              <div class="p-3 p-lg-5 border">
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <label for="text" class="text-black">Lecturer <span class="text-danger">*</span></label>
                    ...
                    ?>
                        ...
                        <option value="<?php echo $rows ['lecId'] ?>"><?php echo $rows ['name']; ?></option>
                ...
                <div class="form-group row">
                  <div class="col-lg-12">
                    <label for="c_email" class="text-black">Message <span class="text-danger">*</span></label>
                    <br />
                    <textarea id="id" name="message" placeholder="Message" cols="40" required></textarea>
                  </div>
                </div>
            ...
            <div class="p-4 border mb-3">
                ...
                <p><img src="images/function5.jpg" width="400" height="300"/></p>
